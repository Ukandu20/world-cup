...
DEFAULT_V2_TRAINING_SCOPE = TRAINING_SCOPE_WORLD_CUP_ONLY

DEFAULT_V3_TRAINING_SCOPE = TRAINING_SCOPE_ALL_INTERNATIONAL

SAMPLE_WEIGHT_POLICY = (
    "World Cup finals=3.0; continental finals=2.5; qualifiers=2.0; "
    "other competitive=1.5; friendlies=1.0"
)
...
DEFAULT_MODEL_RANDOM_STATE = 20260403
