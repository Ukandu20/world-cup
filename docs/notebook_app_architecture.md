...
4. Use the `Analysis` page for detailed historical exploration.
...
- `apps/pages/1_Analysis.py` provides the exploratory depth that used to make the notebook long and hard to review.
