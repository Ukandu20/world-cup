...
def build_v2_probability_artifact(
    ...
    *,
    ...
    """Run the V2 probability simulation and return a persistable artifact payload."""
    model_bundle = load_v2_match_model(match_window, training_scope)
